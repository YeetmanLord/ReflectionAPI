...
public class NMSObjectReflection {
	 ...
	 * Despite bukkitObject being an object it still must be an actual Bukkit object with the method being the method to get the nms equivalent
	 ...
	 */
	public Object invokeMethodForNmsObject(String methodName, @Nonnull Class<?>[] argsClasses, @Nonnull Object[] args)
